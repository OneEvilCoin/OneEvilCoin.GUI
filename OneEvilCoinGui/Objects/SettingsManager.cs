...
using ApiPathSettings = OneEvil.OneEvilCoinAPI.Settings.PathSettings;
...
namespace OneEvil.OneEvilCoinGUI
{
    public static class SettingsManager
    {
        ...
        public class ConfigSectionNetwork : ConfigurationSection
        {
            ...
            [ConfigurationProperty("rpcUrlPortDaemon", DefaultValue = (ushort)8666)]
            ...
            [ConfigurationProperty("rpcUrlPortWallet", DefaultValue = (ushort)9666)]
